...
interface StepReviewProps {
  ...
  /** Anti-spam controls (Turnstile + honeypot), rendered just above submit.
      Passed in rather than built here so this step stays presentational. */
...
export default function StepReview({
  ...
  return (
    <div className="space-y-6">
      ...
      {verification && <div className="relative">{verification}</div>}
      ...
      <div className="flex flex-col gap-3">
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-primary to-emerald-500 text-ink font-bold text-lg rounded-full hover:brightness-110 transition-all shadow-lg shadow-primary/25 disabled:opacity-40 disabled:cursor-not-allowed disabled:shadow-none cursor-pointer"
        >
