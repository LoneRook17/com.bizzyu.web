  ...
  return (
    <Card>
      <CardContent className="py-5">
        <h3 className="text-sm font-semibold text-neutral-900 dark:text-neutral-100">Dashboard preferences</h3>
        <p className="mt-1 text-[13px] text-neutral-500 dark:text-neutral-400">
          Choose what your dashboard is built around. Hidden sections aren&apos;t deleted — switch back anytime.
        </p>
        ...
        <h3 className="mt-6 text-sm font-semibold text-neutral-900 dark:text-neutral-100">Appearance</h3>
        <p className="mt-1 text-[13px] text-neutral-500 dark:text-neutral-400">Theme for this device.</p>
        <div className="mt-3 inline-flex items-center gap-1 rounded-lg bg-neutral-100 p-1 dark:bg-neutral-800">
