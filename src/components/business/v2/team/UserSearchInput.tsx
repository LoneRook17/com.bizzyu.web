  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      {showDropdown && results.length > 0 && (
        <ul className="absolute z-20 mt-1.5 max-h-52 w-full overflow-y-auto rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-1.5 shadow-lg">
          {results.map((user) => (
            <li
              key={user.id}
              className="cursor-pointer rounded-lg px-2.5 py-2 transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-800"
