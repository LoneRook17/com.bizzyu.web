...
export default function V2ManageEventPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const base = `/business/v2/events/${id}/manage`
  ...
  const tiles: Tile[] = [
    { href: `/business/v2/events/${id}/edit`, icon: Pencil, title: "Edit event", subtitle: "Details, tickets, and flyer", show: canEdit },
  ...
  return (
    <>
      ...
      <CancelEventModal
        ...
        onCancelled={() => router.push("/business/v2/events")}
      />
    </>
  )
}
