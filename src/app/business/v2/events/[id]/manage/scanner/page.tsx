  ...
  return (
    <>
      ...
      <Card>
        ...
        <CardContent className="pt-0">
          <p className="mb-2 text-[13px] text-neutral-500">Each ticket QR code contains a URL in this format:</p>
          <div className="break-all rounded-lg bg-neutral-50 px-4 py-3 font-mono text-xs text-neutral-700">
      ...
      <Card>
        <CardHeader className="gap-2"><QrCode className="size-4 text-[#079455]" /><CardTitle>Open scanner</CardTitle></CardHeader>
        <CardContent className="pt-0">
      ...
      <Card className="border-blue-200 bg-blue-50/50">
        <CardContent>
          <h2 className="mb-2 text-sm font-semibold text-blue-800">Tips for door staff</h2>
