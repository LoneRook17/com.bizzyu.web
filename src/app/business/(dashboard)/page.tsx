          ...
          <Card className="overflow-hidden">
            ...
            <div className="border-t border-neutral-100 dark:border-neutral-800">
              {loading ? (
                ...
                <div className="p-5"><EmptyState icon={CalendarDays} title="Nothing coming up" description="Create an event to start selling tickets." action={<Button asChild size="sm"><Link href="/business/events/new"><Plus /> Create event</Link></Button>} /></div>
              ) : (
