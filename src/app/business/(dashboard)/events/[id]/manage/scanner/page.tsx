  ...
  return (
    <>
      <ManageSubheader
        ...
        actions={
          <Button asChild>
            <Link href="/business/scanner"><ScanLine /> Open scanner</Link>
          </Button>
        }
      />
      ...
      <Card>
        ...
        <CardContent className="pt-0">
          <ol className="list-inside list-decimal space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
            ...
            <li>A full-screen confirmation shows the entry type (Entry / Skip the line ticket).</li>
          </ol>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="pt-0">
          ...
          <Button asChild>
            <Link href="/business/scanner"><ScanLine /> Open QR scanner</Link>
          </Button>
        </CardContent>
      </Card>
