    ...
    <div className="max-w-3xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        ...
        <ManageCard
          href={`${base}/promoters`}
          title="Promoters"
          subtitle="View promoter stats and payouts"
          icon={
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 8a3 3 0 116 0 3 3 0 01-6 0zM2 19v-1a3 3 0 013-3h6a3 3 0 013 3v1" />
            </svg>
          }
        />
