...
export default function StudentsPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start">
            ...
            <AnimatedSection delay={0.2} className="flex justify-center">
              <div className="relative w-full h-[440px] lg:h-[580px]">
                {/* Screen 1 - Deals home feed (center back) */}
                ...
                {/* Screen 3 - Deal detail (right, rotated) */}
                <div
      ...
      {/* Features - 2 column cards like businesses page */}
      <SectionContainer>
        <AnimatedSection>
          ...
          <AnimatedSection>
            <div className="bg-white rounded-2xl p-8 md:p-10 border border-gray-100 h-full hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="space-y-3">
                {[
                  "Show the deal, save instantly",
                  "New deals added every week",
                  "Track your total savings",
                  "Curated for your school",
                ].map((item) => (
              ...
              <div className="mt-6">
                <Button href={APP_STORE_URL} variant="outline" size="sm">
                  Browse Deals
                </Button>
              </div>
            </div>
          ...
          <AnimatedSection delay={0.1}>
            <div className="bg-white rounded-2xl p-8 md:p-10 border border-gray-100 h-full hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="space-y-4">
                {[
                  {
                    title: "Buy Tickets In-App",
                    desc: "RSVP or buy tickets directly in Bizzy. No third-party apps.",
                  },
                  {
                    title: "Never Miss Out",
                    desc: "See events curated for your campus as soon as they drop.",
                  },
                  {
                    title: "Compete on the Leaderboard",
                    desc: "Track your savings and rank against your friends.",
                  },
                ].map((item) => (
        ...
        <AnimatedSection>
          <div className="bg-gradient-to-br from-primary to-emerald-500 rounded-3xl p-8 md:p-12 text-white">
            <h3 className="text-2xl md:text-3xl font-bold mb-6">
              Built for the way you live on campus.
            </h3>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                "Deals you won't find anywhere else",
                "New offers and events added every week",
                "Curated for your specific school",
                "Save on food, drinks, and experiences",
                "Works at every partnered campus",
              ].map((point, i) => (
