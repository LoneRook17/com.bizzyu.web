...
- **Students** (iOS app): discover and claim local **deals** (food, drinks,
  things-to-do), buy **event tickets**, and buy **line skips** for nightlife.
  Pitch: real students, real savings, no fees.
- **Businesses & venues** (web dashboard at bizzyu.com/business + the app's business
  tools): list deals, sell tickets and line skips, scan at the door, run promoters
  and marketing, get paid via Stripe.
...
- **Event ticket** — paid or free ticket to a venue event. Lives in the app's Wallet
  tab as a QR code; can be added to Apple Wallet. Scheduled tickets have scan
  windows (valid-from/until times, shown in the event's timezone).
