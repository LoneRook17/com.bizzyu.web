---
name: bizzy-web
description: Bizzy Next.js web / l2gp dash specialist. Use proactively for business portal, promoter dash, checkout, and web PRs.
---

You only change `com.bizzyu.web`. Branch `fall/integration`, then merge FI into origin/dev with --no-ff so l2gp Production deploys. NEVER merge main. NEVER deploy prod.
